...
# gt = GenreTitle.create(movie_id: 11, genre_id: 2)
# gt = GenreTitle.create(movie_id: 11, genre_id: 4)
# gt = GenreTitle.create(movie_id: 11, genre_id: 3)
# gt = GenreTitle.create(movie_id: 12, genre_id: 2)
# gt = GenreTitle.create(movie_id: 12, genre_id: 3)
# gt = GenreTitle.create(movie_id: 12, genre_id: 4)
# gt = GenreTitle.create(movie_id: 12, genre_id: 8)
# gt = GenreTitle.create(movie_id: 12, genre_id: 9)
# gt = GenreTitle.create(movie_id: 13, genre_id: 4)
# gt = GenreTitle.create(movie_id: 13, genre_id: 7)
# gt = GenreTitle.create(movie_id: 13, genre_id: 14)
# gt = GenreTitle.create(movie_id: 14, genre_id: 4)
# gt = GenreTitle.create(movie_id: 15, genre_id: 1)
# gt = GenreTitle.create(movie_id: 15, genre_id: 2)
# gt = GenreTitle.create(movie_id: 15, genre_id: 15)
# gt = GenreTitle.create(movie_id: 15, genre_id: 9)
# gt = GenreTitle.create(movie_id: 16, genre_id: 5)
# gt = GenreTitle.create(movie_id: 16, genre_id: 7)
# gt = GenreTitle.create(movie_id: 16, genre_id: 13)
# gt = GenreTitle.create(movie_id: 16, genre_id: 19)
# gt = GenreTitle.create(movie_id: 17, genre_id: 7)
# gt = GenreTitle.create(movie_id: 17, genre_id: 14)
# gt = GenreTitle.create(movie_id: 18, genre_id: 7)
# gt = GenreTitle.create(movie_id: 18, genre_id: 17)
# gt = GenreTitle.create(movie_id: 18, genre_id: 10)
# gt = GenreTitle.create(movie_id: 19, genre_id: 7)
# gt = GenreTitle.create(movie_id: 20, genre_id: 5)
# gt = GenreTitle.create(movie_id: 20, genre_id: 17)
# gt = GenreTitle.create(movie_id: 20, genre_id: 7)
# gt = GenreTitle.create(movie_id: 21, genre_id: 7)
# gt = GenreTitle.create(movie_id: 21, genre_id: 9)
# gt = GenreTitle.create(movie_id: 21, genre_id: 17)
# gt = GenreTitle.create(movie_id: 21, genre_id: 13)
# gt = GenreTitle.create(movie_id: 21, genre_id: 11)
# gt = GenreTitle.create(movie_id: 22, genre_id: 11)
# gt = GenreTitle.create(movie_id: 22, genre_id: 17)
# gt = GenreTitle.create(movie_id: 23, genre_id: 2)
# gt = GenreTitle.create(movie_id: 23, genre_id: 17)
# gt = GenreTitle.create(movie_id: 23, genre_id: 11)
# gt = GenreTitle.create(movie_id: 24, genre_id: 11)
# gt = GenreTitle.create(movie_id: 25, genre_id: 11)
# gt = GenreTitle.create(movie_id: 26, genre_id: 7)
# gt = GenreTitle.create(movie_id: 26, genre_id: 11)
# gt = GenreTitle.create(movie_id: 27, genre_id: 11)
# gt = GenreTitle.create(movie_id: 27, genre_id: 17)
# gt = GenreTitle.create(movie_id: 28, genre_id: 11)
# gt = GenreTitle.create(movie_id: 29, genre_id: 11)
# gt = GenreTitle.create(movie_id: 29, genre_id: 13)
# gt = GenreTitle.create(movie_id: 30, genre_id: 5)
# gt = GenreTitle.create(movie_id: 30, genre_id: 7)
# gt = GenreTitle.create(movie_id: 31, genre_id: 1)
# gt = GenreTitle.create(movie_id: 31, genre_id: 2)
# gt = GenreTitle.create(movie_id: 31, genre_id: 9)
# gt = GenreTitle.create(movie_id: 31, genre_id: 15)
# gt = GenreTitle.create(movie_id: 32, genre_id: 1)
# gt = GenreTitle.create(movie_id: 32, genre_id: 2)
# gt = GenreTitle.create(movie_id: 32, genre_id: 9)
# gt = GenreTitle.create(movie_id: 32, genre_id: 15)
# gt = GenreTitle.create(movie_id: 33, genre_id: 1)
# gt = GenreTitle.create(movie_id: 33, genre_id: 2)
# gt = GenreTitle.create(movie_id: 33, genre_id: 4)
# gt = GenreTitle.create(movie_id: 34, genre_id: 1)
# gt = GenreTitle.create(movie_id: 34, genre_id: 2)
# gt = GenreTitle.create(movie_id: 34, genre_id: 15)
# gt = GenreTitle.create(movie_id: 35, genre_id: 4)
# gt = GenreTitle.create(movie_id: 35, genre_id: 7)
# gt = GenreTitle.create(movie_id: 35, genre_id: 19)
# gt = GenreTitle.create(movie_id: 35, genre_id: 12)
# gt = GenreTitle.create(movie_id: 36, genre_id: 4)
# gt = GenreTitle.create(movie_id: 36, genre_id: 5)
# gt = GenreTitle.create(movie_id: 36, genre_id: 7)
# gt = GenreTitle.create(movie_id: 36, genre_id: 13)
# gt = GenreTitle.create(movie_id: 37, genre_id: 12)
# gt = GenreTitle.create(movie_id: 37, genre_id: 7)
# gt = GenreTitle.create(movie_id: 37, genre_id: 10)
# gt = GenreTitle.create(movie_id: 38, genre_id: 7)
# gt = GenreTitle.create(movie_id: 38, genre_id: 12)
# gt = GenreTitle.create(movie_id: 39, genre_id: 5)
# gt = GenreTitle.create(movie_id: 39, genre_id: 7)
# gt = GenreTitle.create(movie_id: 39, genre_id: 17)
# gt = GenreTitle.create(movie_id: 40, genre_id: 5)
# gt = GenreTitle.create(movie_id: 40, genre_id: 7)
# gt = GenreTitle.create(movie_id: 40, genre_id: 17)
# gt = GenreTitle.create(movie_id: 40, genre_id: 11)
# gt = GenreTitle.create(movie_id: 41, genre_id: 11)
# gt = GenreTitle.create(movie_id: 42, genre_id: 1)
# gt = GenreTitle.create(movie_id: 42, genre_id: 2)
# gt = GenreTitle.create(movie_id: 42, genre_id: 4)
# gt = GenreTitle.create(movie_id: 42, genre_id: 15)
# gt = GenreTitle.create(movie_id: 43, genre_id: 7)
# gt = GenreTitle.create(movie_id: 43, genre_id: 15)
# gt = GenreTitle.create(movie_id: 44, genre_id: 1)
# gt = GenreTitle.create(movie_id: 44, genre_id: 2)
# gt = GenreTitle.create(movie_id: 44, genre_id: 15)
# gt = GenreTitle.create(movie_id: 45, genre_id: 1)
# gt = GenreTitle.create(movie_id: 45, genre_id: 2)
# gt = GenreTitle.create(movie_id: 45, genre_id: 15)
# gt = GenreTitle.create(movie_id: 46, genre_id: 1)
# gt = GenreTitle.create(movie_id: 46, genre_id: 17)
# gt = GenreTitle.create(movie_id: 46, genre_id: 15)
# gt = GenreTitle.create(movie_id: 47, genre_id: 2)
# gt = GenreTitle.create(movie_id: 47, genre_id: 4)
# gt = GenreTitle.create(movie_id: 47, genre_id: 15)
# gt = GenreTitle.create(movie_id: 47, genre_id: 8)
# gt = GenreTitle.create(movie_id: 48, genre_id: 15)
# gt = GenreTitle.create(movie_id: 48, genre_id: 13)
# gt = GenreTitle.create(movie_id: 48, genre_id: 2)
# gt = GenreTitle.create(movie_id: 49, genre_id: 15)
# gt = GenreTitle.create(movie_id: 49, genre_id: 7)
# gt = GenreTitle.create(movie_id: 49, genre_id: 17)
# gt = GenreTitle.create(movie_id: 50, genre_id: 15)
# gt = GenreTitle.create(movie_id: 50, genre_id: 7)
# gt = GenreTitle.create(movie_id: 51, genre_id: 8)
# gt = GenreTitle.create(movie_id: 51, genre_id: 3)
# gt = GenreTitle.create(movie_id: 51, genre_id: 7)
# gt = GenreTitle.create(movie_id: 52, genre_id: 1)
# gt = GenreTitle.create(movie_id: 52, genre_id: 4)
# gt = GenreTitle.create(movie_id: 52, genre_id: 9)
# gt = GenreTitle.create(movie_id: 52, genre_id: 40)
# gt = GenreTitle.create(movie_id: 52, genre_id: 39)
# gt = GenreTitle.create(movie_id: 52, genre_id: 33)
# gt = GenreTitle.create(movie_id: 53, genre_id: 31)
# gt = GenreTitle.create(movie_id: 53, genre_id: 7)
# gt = GenreTitle.create(movie_id: 53, genre_id: 12)
# gt = GenreTitle.create(movie_id: 53, genre_id: 10)
# gt = GenreTitle.create(movie_id: 54, genre_id: 31)
# gt = GenreTitle.create(movie_id: 54, genre_id: 7)
# gt = GenreTitle.create(movie_id: 55, genre_id: 6)
# gt = GenreTitle.create(movie_id: 55, genre_id: 31)
# gt = GenreTitle.create(movie_id: 55, genre_id: 22)
# gt = GenreTitle.create(movie_id: 56, genre_id: 5)
# gt = GenreTitle.create(movie_id: 56, genre_id: 7)
# gt = GenreTitle.create(movie_id: 56, genre_id: 10)
# gt = GenreTitle.create(movie_id: 56, genre_id: 17)
# gt = GenreTitle.create(movie_id: 57, genre_id: 7)
# gt = GenreTitle.create(movie_id: 57, genre_id: 5)
# gt = GenreTitle.create(movie_id: 58, genre_id: 4)
# gt = GenreTitle.create(movie_id: 58, genre_id: 12)
# gt = GenreTitle.create(movie_id: 58, genre_id: 14)
# gt = GenreTitle.create(movie_id: 58, genre_id: 5)
# gt = GenreTitle.create(movie_id: 59, genre_id: 3)
# gt = GenreTitle.create(movie_id: 59, genre_id: 40)
# gt = GenreTitle.create(movie_id: 59, genre_id: 39)
# gt = GenreTitle.create(movie_id: 59, genre_id: 21)
# gt = GenreTitle.create(movie_id: 61, genre_id: 4)
# gt = GenreTitle.create(movie_id: 61, genre_id: 32)
# gt = GenreTitle.create(movie_id: 62, genre_id: 23)
# gt = GenreTitle.create(movie_id: 63, genre_id: 23)
# gt = GenreTitle.create(movie_id: 64, genre_id: 25)
# gt = GenreTitle.create(movie_id: 65, genre_id: 6)
# gt = GenreTitle.create(movie_id: 65, genre_id: 22)
# gt = GenreTitle.create(movie_id: 65, genre_id: 26)
# gt = GenreTitle.create(movie_id: 66, genre_id: 6)
# gt = GenreTitle.create(movie_id: 66, genre_id: 29)
